...
class TestAnnoyIndexReader(unittest.TestCase):
    """Test for reading the assets required for Annoy Indexer"""
...
class TestAnnoyIndexClass(unittest.TestCase):
    """Tests for getting indexes from Annoy indexer"""
...
class TestFaissIndexReaderClass(unittest.TestCase):
    """Test for reading the assets required for Faiss Indexer"""
...
class TestFaissIndexClass(unittest.TestCase):
    """Tests for getting indexes from Faiss indexer"""
...
class TestIndexesDirectory(unittest.TestCase):
    """Test for checking index generated from different indexers"""
